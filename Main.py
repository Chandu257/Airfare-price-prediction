...
main = Tk()
main.title("Airfare Prices Prediction Using Machine Learning Techniques")
...
font = ('times', 15, 'bold')
title = Label(main, text='Airfare Prices Prediction Using Machine Learning Techniques')
